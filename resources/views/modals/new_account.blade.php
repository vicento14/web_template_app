                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-4">
                            ...
                            <input type="text" id="employee_no" maxlength="20" class="form-control" autocomplete="off"
                                required>
                        </div>
                        <div class="col-4">
                            <label>Full Name:</label><label style="color: red;">*</label>
                            <input type="text" id="full_name" maxlength="50" class="form-control" autocomplete="off"
                                required>
                        </div>
                        <div class="col-4">
                            <label>Username:</label><label style="color: red;">*</label>
                            <input type="text" id="username" maxlength="50" class="form-control" autocomplete="off"
                                required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            ...
                            <input type="password" id="password" maxlength="50" class="form-control" autocomplete="off"
                                required>
                        </div>
                        <div class="col-4">
                            <label>Section:</label><label style="color: red;">*</label>
                            <input type="text" id="section" maxlength="50" class="form-control" autocomplete="off"
                                required>
                        </div>
                        <div class="col-4">
